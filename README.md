...
Challenges are generated by AI, but are stored in a static file that is human-editable.

Skip to the "[examples](#examples)" section if you want the gestalt of what this app does.
